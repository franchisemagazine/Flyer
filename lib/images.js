...
export const VERIFIED_PRODUCT_REFERENCES = {
  S938U: {
    name: 'SAMSUNG GALAXY S25 ULTRA (SM-S938U)',
    source: 'https://www.bestbuy.com/product/samsung-galaxy-s25-ultra-512gb-s938u-unlocked-titanium-jetblack-titanium-jet-black/J3ZYG2VVTV',
    image: 'https://pisces.bbystatic.com/image2/BestBuy_US/images/products/b9e810d8-4e7a-434d-9a77-500c83aab072.jpg',
  },
};

export function verifiedProductReference(model){
  return VERIFIED_PRODUCT_REFERENCES[normalize(model)] || null;
}
