...
test('malformed field types fail validation instead of throwing',()=>{for(const fields of [null,[],{...valid,whatsapp:123},{...valid,additional:{text:'bad'}},{...valid,email:['bad']}])assert.ok(Object.keys(validateFields(fields,catalog)).length);});
